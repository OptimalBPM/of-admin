...
export class SchemaTreeComponent implements OnInit, ITree {
    ...
    */
        ...
        if (item.id !== this.newNodeObjectId) {
            if (Object.keys(this.data).length > 0) {
                ...
                if ((nodeScope) && ("expanded" in data) && (data["expanded"] === true)) {
                    setTimeout(() => {
                        this.onAsyncToggleChildren.bind(null, nodeScope, item)
                    }, 4000);
                }
            }
        }
    ...
    ngOnInit() {
        ...
        if (this.nodeManager) {
            ...
            console.log("Initiating schemaTree this.nodeManager not set!");
        }
